...
class AgricolaAI:
    ...
    def reset(self):
        ...
        self.improvement_2 = {'name': 'improvement_2','price': [2, 0, 0],
                              'resource_food': {'grain_wood_food': 2, 'clay_food': 0, 'reed_food': 0, 'wood_food': 0, 'grain_food': 0},
                              'livestock_food': {'sheep_food': 2, 'boar_food': 2, 'cow_food': 3},
                              'point': {'clay_point': 0, 'reed_point': 0, 'wood_point': 0, 'grain_point': 0, '3_random_point': 0}}
        self.improvement_3a =   {'name': 'improvement_3a', 'price': [3, 0, 0],
                                'resource_food': {'grain_wood_food': 5, 'clay_food': 0, 'reed_food': 0, 'wood_food': 0, 'grain_food': 0},
        ...
        self.improvement_4 = {'name': 'improvement_4', 'price': [4, 0, 0],
                               'resource_food': {'grain_wood_food': 3, 'clay_food': 0, 'reed_food': 0, 'wood_food': 0, 'grain_food': 0},
        ...
        self.improvement_7 = {'name': 'improvement_7', 'price': [3, 0, 1],
                              'resource_food': {'grain_wood_food': 0, 'clay_food': 0, 'reed_food': 0, 'wood_food': 0, 'grain_food': 3},
                              'livestock_food': {'sheep_food': 0, 'boar_food': 0, 'cow_food': 0},
                              'point': {'clay_point': 0, 'reed_point': 0, 'wood_point': 0, 'grain_point': 1, '3_random_point': 0}}

        self.improvement_9 = {'name': 'improvement_9', 'price': [0, 1, 2],
                              'resource_food': {'grain_wood_food': 0, 'clay_food': 0, 'reed_food': 3, 'wood_food': 0, 'grain_food': 0},
                              'livestock_food': {'sheep_food': 0, 'boar_food': 0, 'cow_food': 0},
                              'point': {'clay_point': 0, 'reed_point': 1, 'wood_point': 0, 'grain_point': 0, '3_random_point': 0}}

        self.improvement_10 = {'name': 'improvement_10', 'price': [1, 2, 0],
                              'resource_food': {'grain_wood_food': 0, 'clay_food': 2, 'reed_food': 0, 'wood_food': 0, 'grain_food': 0},
                              'livestock_food': {'sheep_food': 0, 'boar_food': 0, 'cow_food': 0},
                              'point': {'clay_point': 1, 'reed_point': 0, 'wood_point': 0, 'grain_point': 0, '3_random_point': 0}}

        self.improvement_11 = {'name': 'improvement_11', 'price': [2, 0, 1],
                               'resource_food': {'grain_wood_food': 0, 'clay_food': 0, 'reed_food': 0, 'wood_food': 2, 'grain_food': 0},
                               'livestock_food': {'sheep_food': 0, 'boar_food': 0, 'cow_food': 0},
                               'point': {'clay_point': 0, 'reed_point': 0, 'wood_point': 1, 'grain_point': 0, '3_random_point': 0}}

        self.improvement_14 = {'name': 'improvement_14', 'price': [1, 1, 1],
                               'resource_food': {'grain_wood_food': 0, 'clay_food': 0, 'reed_food': 0, 'wood_food': 0, 'grain_food': 0},
                               'livestock_food': {'sheep_food': 0, 'boar_food': 0, 'cow_food': 0},
                               'point': {'clay_point': 0, 'reed_point': 0, 'wood_point': 0, 'grain_point': 0, '3_random_point': 1}}
    ...
    def action_b(self, player_state, player_field_dict, player_improvements):
        ...
        pasteur_type = pasteur_list[random_choice]
        print(f'The player chose {pasteur_type}')
        ...
        if random_choice == 0:
            ...
            if self.tiles['pasteur_2'] > 0:
                ...
                if player_state['clay'] >= pasteur_2["price"][0] and player_state['reed'] >= pasteur_2["price"][1] and player_state['wood'] >= pasteur_2["price"][2]:
                    # Player pays
        ...
        if random_choice == 1:
            ...
            if self.tiles['pasteur_4'] > 0:
                # Check player's payment
                if player_state['clay'] >= pasteur_4["price"][0] and player_state['reed'] >= pasteur_4["price"][1] and player_state['wood'] >= pasteur_4["price"][2]:
                    # Player pays
        ...
        if random_choice == 2:
            ...
            if self.tiles['pasteur_6'] > 0:
                # Check player's payment
                if player_state['clay'] >= pasteur_6["price"][0] and player_state['reed'] >= pasteur_6["price"][1] and player_state['wood'] >= pasteur_6["price"][2]:
                    # Player pays
        ...
        if random_choice == 3:
            ...
            if self.tiles['pasteur_8'] > 0:
                # Check player's payment
                if player_state['clay'] >= pasteur_8["price"][0] and player_state['reed'] >= pasteur_8["price"][1] and player_state['wood'] >= pasteur_8["price"][2]:
                    # Player pays
        ...
        self.assign_livestock(player_state, acquired_sheeps=0, acquired_boars=0, acquired_cows=0)

        # Remove this action from the current round
        self.moves = [x for x in self.moves if x != 'action_b']
    ...
    def action_k(self, player_state, player_field_dict, player_improvements):
        acquired_sheeps = self.board_resouce['sheep']
        acquired_boars = 0
        acquired_cows = 0
    ...
    def action_6(self, player_state, player_field_dict, player_improvements):
        acquired_sheeps = 0
        acquired_boars = self.board_resouce['boar']
        acquired_cows = 0
        # Assign livestocks
        self.assign_livestock(player_state, acquired_sheeps, acquired_boars, acquired_cows)
    ...
    def action_7(self, player_state, player_field_dict, player_improvements):
        if self.improvement_7 in self.improvements:
            # Check player's payment
            if player_state['clay'] >= self.improvement_7["price"][0] and player_state['reed'] >= self.improvement_7["price"][1] and player_state['wood'] >= self.improvement_7["price"][2]:
                # Player pays
    ...
    def action_8(self, player_state, player_field_dict, player_improvements):
        acquired_sheeps = 0
        acquired_boars = 0
        acquired_cows = self.board_resouce['cow']
        # Assign livestocks
        self.assign_livestock(player_state, acquired_sheeps, acquired_boars, acquired_cows)
    ...
    def action_9(self, player_state, player_field_dict, player_improvements):
        if self.improvement_9 in self.improvements:
            # Check player's payment
            if player_state['clay'] >= self.improvement_9["price"][0] and player_state['reed'] >= self.improvement_9["price"][1] and player_state['wood'] >= self.improvement_9["price"][2]:
                # Player pays
    ...
    def action_10(self, player_state, player_field_dict, player_improvements):
        if self.improvement_10 in self.improvements:
            # Check player's payment
            if player_state['clay'] >= self.improvement_10["price"][0] and player_state['reed'] >= self.improvement_10["price"][1] and player_state['wood'] >= self.improvement_10["price"][2]:
                # Player pays
    ...
    def action_11(self, player_state, player_field_dict, player_improvements):
        if self.improvement_11 in self.improvements:
            # Check player's payment
            if player_state['clay'] >= self.improvement_11["price"][0] and player_state['reed'] >= self.improvement_11["price"][1] and player_state['wood'] >= self.improvement_11["price"][2]:
                # Player pays
    ...
    def action_14(self, player_state, player_field_dict, player_improvements):
        if self.improvement_14 in self.improvements:
            # Check player's payment
            if player_state['clay'] >= self.improvement_14["price"][0] and player_state['reed'] >= self.improvement_14["price"][1] and player_state['wood'] >= self.improvement_14["price"][2]:
                # Player pays
    ...
    def use_livestock_to_feed(self, player_state, player_missing_foods, player_improvements):
        ...
        print(f'{improvement} was used on {feeding_option[0]} sheeps, {feeding_option[1]} boars, and {feeding_option[2]} cows to exchanged for {acquired_food} foods')
    ...
    def harvesting(self, player_state, player_field_dict, player_improvements):
        ...
        if player_missing_foods < 0:
            ...
            if player_missing_foods < 0:
                ...
                player_missing_foods = self.use_livestock_to_feed(player_state, player_missing_foods, player_improvements)
    ...
    def point_cal(self, player_state):
        ...
        player_points = player_state['farmer']*3 - player_state['begging']*3 + \
                        player_state['clay_conversion'] + player_state['clay_room'] + player_state['pasteur_2'] + player_state['pasteur_4'] + player_state['pasteur_6'] + player_state['pasteur_8'] + player_state['stable'] + player_state['field'] + \
...
while game.round < 15:
    ...
    # print('Player 1 state:')
    # print(game.player1_state)
    # print('Player 1 fields:')
    # print(game.player1_field_dict)
    # print('Player 2 state:')
    # print(game.player2_state)
    # print('Player 2 fields:')
    # print(game.player2_field_dict)
    # print('Player 3 state:')
    # print(game.player3_state)
    # print('Player 3 fields:')
    # print(game.player3_field_dict)
    # print('Player 4 state:')
    # print(game.player4_state)
    # print('Player 4 fields:')
    # print(game.player4_field_dict)
...
def run_single_game(game):
    ...
    while game.round < 15:
        logger.info(f'This is round {game.round}')
        ...
        print_state('Board resource', game.board_resouce)
        for i in range(1, 5):
