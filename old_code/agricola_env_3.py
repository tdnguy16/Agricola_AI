...
class AgricolaAI:
    ...
    def reset(self):
        ...
        self.player1_state = {'action': 0, 'point': 0, 'round': 0, 'clay': 0, 'reed': 0, 'wood': 0, 'grain': 0, 'food': 0,
                              'sheep': 0, 'boar': 0,
                              'cow': 0,
    ...
    def check_negative_resource(self, data):
        ignore_indices = [1, 27, 53, 79]  # Indices to be ignored
    ...
    def step(self, action):
            ...
            for order in self.player_order:
                ...
                if order == 'player1':
                    if self.player1_number_actions != 0:
                        ...
                        self.player1_state['action'] = action[action_index]
        ...
        reward = self.calculate_reward('sheep')
