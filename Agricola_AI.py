...
class AgricolaAI:
    ...
    def calculate_reward(self, previous_state):
        ...
        reward = 0
        reward += self.valid_action_reward(self.player1_state, previous_state) * 50
...
if training == True:
    ...
    output_data = {
        ...
        "partner_learning_rate": partner_learning_rate,
        "agent_entropy": agent_entropy,
        "agent_learning_rate": agent_learning_rate,

        "resource_player1": resource_player1,
        "resource_player2": resource_player2,
        "resource_player3": resource_player3,
        "resource_player4": resource_player4,

        "average_points_player1": average_points_player1,
        "average_points_player2": average_points_player2,
        "average_points_player3": average_points_player3,
        "average_points_player4": average_points_player4}
    ...
    for training_round in range(1, training_rounds, 1):
        ...
        moves_total_levels = {'INVALID': 0, 'action_a': 1, 'action_b': 2, 'action_c': 2,
        ...
        if training_round == 1:
            ...
            partner_model = PPO.load(f"E:\\Agricola\\{model_name}_{training_round-1}", env=AgricolaEnv())
        ...
        # Load previous model
        if training_round == 1:
            model = PPO.load(f"E:\\Agricola\\{starting_model}", env=env)

        else:
            model = model.load(f"E:\\Agricola\\{model_name}_{training_round-1}", env=env)

        model.ent_coef = agent_entropy
        model.learning_rate = agent_learning_rate

        # Traing and saved new model
        model.learn(total_timesteps=times_steps)
        model.save(f"E:\\Agricola\\{model_name}_{training_round}")
        ...
        chart_occurrences_with_levels(total_action_used, moves_total_levels,
                          f'{model_name}_Occurrences_of_Actions_total_training round {training_round + 1}.png',
                          save_path)
        chart_occurrences_with_levels(agent_action_used, moves_total_levels,
                          f'{model_name}_Occurrences_of_Actions_agent_training round {training_round + 1}.png',
                          save_path)
        chart_occurrences_with_levels(partner_action_used, moves_total_levels,
                          f'{model_name}_Occurrences_of_Actions_partner_training round {training_round + 1}.png',
                          save_path)
        ...
        plot_level_occurrences(agent_level_occurrences,
                               f'{model_name}_Agent_Actions_Levels_training round {training_round + 1}.png', save_path)
        plot_level_occurrences(total_level_occurrences,
                               f'{model_name}_Total_Actions_Levels_training round {training_round + 1}.png', save_path)
        plot_level_occurrences(partner_level_occurrences,
                               f'{model_name}_Partner_Actions_Levels_training round {training_round + 1}.png',
                               save_path)

        output_data_training_round = {
            f"total_action_used_training round_{training_round}": total_action_used,
            f"agent_action_used_training round_{training_round}": agent_action_used,
            f"partner_action_used_training round_{training_round}": partner_action_used,
            f"final_points_player1_training round_{training_round}": final_points_player1,
            f"final_points_player2_training round_{training_round}": final_points_player2,
            f"final_points_player3_training round_{training_round}": final_points_player3,
            f"final_points_player4_training round_{training_round}": final_points_player4,
            f"improvement_player1_training round_{training_round}": improvement_player1,
            f"improvement_player2_training round_{training_round}": improvement_player2,
            f"improvement_player3_training round_{training_round}": improvement_player3,
            f"improvement_player4_training round_{training_round}": improvement_player4,

            f"agent_action_round_1_training round_{training_round}": agent_action_round_1,
            f"agent_action_round_2_training round_{training_round}": agent_action_round_2,
            f"agent_action_round_3_training round_{training_round}": agent_action_round_3,
            f"agent_action_round_4_training round_{training_round}": agent_action_round_4,
            f"agent_action_round_5_training round_{training_round}": agent_action_round_5,
            f"agent_action_round_6_training round_{training_round}": agent_action_round_6,
            f"agent_action_round_7_training round_{training_round}": agent_action_round_7,
            f"agent_action_round_8_training round_{training_round}": agent_action_round_8,
            f"agent_action_round_9_training round_{training_round}": agent_action_round_9,
            f"agent_action_round_10_training round_{training_round}": agent_action_round_10,
            f"agent_action_round_11_training round_{training_round}": agent_action_round_11,
            f"agent_action_round_12_training round_{training_round}": agent_action_round_12,
            f"agent_action_round_13_training round_{training_round}": agent_action_round_13,
            f"agent_action_round_14_training round_{training_round}": agent_action_round_14,

            f"partner_action_round_1_training round_{training_round}": partner_action_round_1,
            f"partner_action_round_2_training round_{training_round}": partner_action_round_2,
            f"partner_action_round_3_training round_{training_round}": partner_action_round_3,
            f"partner_action_round_4_training round_{training_round}": partner_action_round_4,
            f"partner_action_round_5_training round_{training_round}": partner_action_round_5,
            f"partner_action_round_6_training round_{training_round}": partner_action_round_6,
            f"partner_action_round_7_training round_{training_round}": partner_action_round_7,
            f"partner_action_round_8_training round_{training_round}": partner_action_round_8,
            f"partner_action_round_9_training round_{training_round}": partner_action_round_9,
            f"partner_action_round_10_training round_{training_round}": partner_action_round_10,
            f"partner_action_round_11_training round_{training_round}": partner_action_round_11,
            f"partner_action_round_12_training round_{training_round}": partner_action_round_12,
            f"partner_action_round_13_training round_{training_round}": partner_action_round_13,
            f"partner_action_round_14_training round_{training_round}": partner_action_round_14
        }

        output_data.update(output_data_training_round)

    plot_points_trend(average_points_player1, average_points_player2, average_points_player3, average_points_player4,
                      name=model_name, save_path=save_path)
    ...
    plot_action_occurrences_per_round_colored(moves_total_levels, agent_action_round_1, agent_action_round_2,
                                              agent_action_round_3, agent_action_round_4, agent_action_round_5,
                                              agent_action_round_6, agent_action_round_7, agent_action_round_8,
                                              agent_action_round_9, agent_action_round_10, agent_action_round_11,
                                              agent_action_round_12, agent_action_round_13, agent_action_round_14,
                                              player='Agent', name=model_name, save_path=save_path)
    plot_action_occurrences_per_round_colored(moves_total_levels, partner_action_round_1, partner_action_round_2,
                                              partner_action_round_3, partner_action_round_4, partner_action_round_5,
                                              partner_action_round_6, partner_action_round_7, partner_action_round_8,
                                              partner_action_round_9, partner_action_round_10, partner_action_round_11,
                                              partner_action_round_12, partner_action_round_13, partner_action_round_14,
                                              player='Partner', name=model_name, save_path=save_path)


    with open(f"G:\My Drive\Agricola_AI\Outputs data\output_data_{model_name}.json", "w") as file:
...
# ======================================================================================================================
### Entropy: small = exploitation, big = exploration

### Training procedures
# Phase 1 - train to for VALID actions
# model_name = "Agricola_1"
# starting_model = 'BASE'
# times_steps = 1000000
# training_rounds = 10
